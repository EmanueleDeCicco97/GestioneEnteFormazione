...
<body>
	...
	<form action="/eliminaInsegna" method="post">
		<h2>Elimina Insegnamento per ID</h2>
		<label for="id_insegnamento">Scegli Corso:</label>
        <select name=id_insegnamento id="id_insegnamento">
            <% List<Insegna> insegnamenti2 = (ArrayList) request.getAttribute("insegnamenti");
            for (Insegna i : insegnamenti2) { %>
