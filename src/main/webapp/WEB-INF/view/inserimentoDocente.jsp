...
<body>
	...
	<form action="/insertDocente" method="post">
		<h2>Inserisci Docente</h2>	
		<label for="nome_docente">Nome:</label> <input type="text" name="nome_docente" id="nome_docente" required><br>
		<label for="cognome_docente">Cognome:</label> <input type="text" name="cognome_docente" id="cognome_docente" required><br>
