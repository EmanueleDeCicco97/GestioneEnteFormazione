...
<body>
	...
	<form action="/eliminaCorso" method="post">
		<h2>Elimina Corso per ID</h2>
		<label for="id_corso">Scegli Corso:</label>
        <select name="id_corso" id="id_corso">
            <% List<Corso> corso2 = (ArrayList) request.getAttribute("corsi");
            for (Corso c : corso2) { %>
