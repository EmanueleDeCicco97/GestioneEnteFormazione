...
<body>
    ...
    <% List<Corsista> corsisti = (List<Corsista>) request.getAttribute("corsisti");
        for (Corsista corsista : corsisti) { %>
    <tr>
        <td style="padding-right: 10px;"><%= corsista.getCf_corsista() %></td>
        <td style="padding-right: 10px;"><%= corsista.getNome_corsista() %></td>
        <td style="padding-right: 10px;"><%= corsista.getCognome_corsista() %></td>
    </tr>
    <% } %>
</table>
