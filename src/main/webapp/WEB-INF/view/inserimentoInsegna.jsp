...
<body>
	...
	<form action="/inserimentoInsegna" method="post">
		...
		<label for="cf_docente">Scegli Docente:</label>
        <select name="cf_docente" id="cf_docente">
            <% List<Docente> docenti = (ArrayList) request.getAttribute("docenti");
            for (Docente d : docenti) { %>
            <option value="<%= d.getCf_docente()%>"><%= d.getCf_docente()%></option>
            <% } %>
        </select><br><br>
        
		<label for="prezzo_docente">Prezzo Docente:</label>
