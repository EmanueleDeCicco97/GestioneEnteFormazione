...
<%@page import="com.emanuele.gestionerf.model.Partecipazione"%>
...
<body>
    ...
    <h1>Lista Assegnazione Docente al Corso</h1>
	<table>
		<tr>
			<th style="padding-right: 10px;">ID Insegnamento</th>
			<th style="padding-right: 10px;">ID Corso</th>
			<th style="padding-right: 10px;">CF Docente</th>
			<th style="padding-right: 10px;">Prezzo Docente</th>
			<th style="padding-right: 10px;">Pagato</th>
		</tr>
		<%
			List<Insegna> insegnamenti = (List<Insegna>) request.getAttribute("insegnamenti");
			for (Insegna insegnamento : insegnamenti) {
		%>
		<tr>
			<td style="padding-right: 10px;"><%= insegnamento.getId_insegnamento() %></td>
			<td style="padding-right: 10px;"><%= insegnamento.getCorso().getId_corso() %></td>
			<td style="padding-right: 10px;"><%= insegnamento.getDocente().getCf_docente() %></td>
			<td style="padding-right: 10px;"><%= insegnamento.getPrezzo_docente() %></td>
			<td style="padding-right: 10px;"><%= insegnamento.getPagato() %></td>
		</tr>
		<%
			}
		%>
