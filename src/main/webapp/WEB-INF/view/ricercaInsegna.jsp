...
<body>
	...
	<form action="/ricercaInsegna" method="post">
		<h2>Ricerca Insegnamento per ID</h2>
		<label for="id_insegnamento">Scegli Docente:</label>
        <select name=id_insegnamento id="id_insegnamento">
            <% List<Insegna> insegnamenti = (ArrayList) request.getAttribute("insegnamenti");
            for (Insegna i : insegnamenti) { %>
