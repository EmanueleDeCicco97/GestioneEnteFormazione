...
<body>
	...
	<table>
		<tr>
			...
			<th style="padding-right: 10px;">Tipologia</th>
			<th style="padding-right: 10px;">Data Inizio</th>
			<th style="padding-right: 10px;">Data Fine</th>
			<th style="padding-right: 10px;">Prezzo</th>
			<th style="padding-right: 10px;">Numero Rate</th>
		</tr>
		<%
		...
		%>
		<tr>
			<td style="padding-right: 10px;"><%= corso.getId_corso() %></td>
			<td style="padding-right: 10px;"><%= corso.getTipologia() %></td>
			<td style="padding-right: 10px;"><%= corso.getData_inizio() %></td>
			<td style="padding-right: 10px;"><%= corso.getData_fine() %></td>
			<td style="padding-right: 10px;"><%= corso.getPrezzo() %></td>
			<td style="padding-right: 10px;"><%= corso.getN_rate() %></td>
		</tr>
		<%
			}
		%>
