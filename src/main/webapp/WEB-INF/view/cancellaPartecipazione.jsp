...
<body>
    ...
    <form action="/eliminapartecipazione" method="post">
  	    <h2>Elimina Partecipazione</h2>
        <label for="nIscrizione">Scegli Il Numero Iscrizione:</label>
        <select name="nIscrizione" id="nIscrizione">
            <% List<Partecipazione> partecipazioni3 = (ArrayList) request.getAttribute("partecipazioni");
            for (Partecipazione p : partecipazioni3) { %>
