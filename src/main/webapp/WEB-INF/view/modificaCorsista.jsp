...
<body>
	...
	<form action="/modificaCorsista" method="post">
		<h2>Modifica Nome e Cognome per CF Corsista</h2>
		<label for="cf_corsista">Codice Fiscale:</label>
		<input type="text" name="cf_corsista" id="cf_corsista" required><br>
		<label for="nome_corsista">Nuovo Nome:</label>
		<input type="text" name="nome_corsista" id="nome_corsista" required><br>
		<label for="cognome_corsista">Nuovo Cognome:</label>
		<input type="text" name="cognome_corsista" id="cognome_corsista" required><br>
