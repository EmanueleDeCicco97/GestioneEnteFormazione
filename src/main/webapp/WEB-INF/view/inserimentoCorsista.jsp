...
<body>
    ...
    <div class="content">
        ...
        <form action="/insertCorsista" method="post" >
        <h2>Inserisci Corsista</h2>
            <label for="nome_corsista">Nome:</label>
            <input type="text" id="nome_corsista" name="nome_corsista" required><br>
            <label for="cognome_corsista">Cognome:</label>
            <input type="text" id="cognome_corsista" name="cognome_corsista" required><br>
            <label for="cf_corsista">Codice Fiscale:</label>
            <input type="text" id="cf_corsista" name="cf_corsista" required><br>
