...
<body>
    ...
    <form action="/ricercaPartecipazione" method="get">
    	<h2>Ricerca Partecipazione</h2>
        <label for="nIscrizione">Scegli Il Numero Iscrizione:</label>
        <select name="nIscrizione" id="nIscrizione">
            <% List<Partecipazione> partecipazioni = (ArrayList) request.getAttribute("partecipazioni");
