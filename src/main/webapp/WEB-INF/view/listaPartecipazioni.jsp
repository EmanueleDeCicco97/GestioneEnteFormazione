...
<body>
    ...
    <h1>Lista Assegnazione Corsista al Corso</h1>
	<table>
		<tr>
			<th style="padding-right: 10px;">ID Iscrizione</th>
			<th style="padding-right: 10px;">CF Corsista</th>
			<th style="padding-right: 10px;">ID Corso</th>		
			<th style="padding-right: 10px;">Saldato</th>
		</tr>
		<%
			List<Partecipazione> partecipazioni = (List<Partecipazione>) request.getAttribute("partecipazioni");
			for (Partecipazione partecipazione : partecipazioni) {
		%>
		<tr>
			<td style="padding-right: 10px;"><%=  partecipazione.getnIscrizione()%></td>
			<td style="padding-right: 10px;"><%=  partecipazione.getCorsista()%></td>
			<td style="padding-right: 10px;"><%=  partecipazione.getCorso()%></td>
			<td style="padding-right: 10px;"><%=  partecipazione.isSaldato()%></td>
