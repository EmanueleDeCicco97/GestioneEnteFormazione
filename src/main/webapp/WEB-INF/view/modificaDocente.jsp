...
<body>
	...
	<form action="/modificaDocente" method="post">
		<h2>Modifica Nome e Cognome per CF Docente</h2>
		<label for="cf_docente">Codice Fiscale:</label> <input type="text" name="cf_docente" id="cf_docente" required><br>
		<label for="nome_docente">Nuovo Nome:</label> <input type="text" name="nome_docente" id="nome_docente" required><br>
		<label for="cognome_docente">Nuovo Cognome:</label> <input type="text" name="cognome_docente" id="cognome_docente" required><br>
